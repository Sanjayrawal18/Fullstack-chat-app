          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='form-control'>
              ...
              <div className='relative'>
                ...
                <input type="email" className={`input input-bordered w-full pl-10`} placeholder='Johndoe@gmail.com' value={formData.email} onChange={(e) => setformData({ ...formData, email: e.target.value })} />
              </div>
            </div>
            <div className='form-control'>
              <label className='label'>
